function [xn yn Uout] = fresnelPropAngSpecMulti(Uin, wvl, delta1, deltan, z)
...
z       = [0 z]; % propagation plane locations n = length(z);
...
for idx = 1:n-1
    ...
    fY      = ny * deltaf;
    fsq     = fX.^2 + fY.^2;
    Z       = Delta_z(idx); % propagation distance % quadratic phase factor
